...
RUN echo 'deb https://repo.download.nvidia.com/jetson/common r32.7 main' >> /etc/apt/sources.list.d/nvidia-l4t-apt-source.list && echo 'deb https://repo.download.nvidia.com/jetson/t186 r32.7 main' >> /etc/apt/sources.list.d/nvidia-l4t-apt-source.list
